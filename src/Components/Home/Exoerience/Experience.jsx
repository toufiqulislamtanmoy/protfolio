    ...
    return (
        <div id='experience' className="lg:flex justify-between my-24 gap-5" >
            <div className="lg:w-1/2" >
                <h1 className="text-center text-5xl font-extralight" data-aos="fade-right">Education</h1>
            ...
            <div className="lg:w-1/2" >
                <h1 className="text-center text-5xl font-extralight"  data-aos="fade-left">Work Experience</h1>
